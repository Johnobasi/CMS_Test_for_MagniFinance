...
//                    context.SaveChanges();
//                }
//                if (!context.CourseManagements.Any())
//                {
//                    context.CourseManagements.Add(new CourseManagement() { StudentId = 1, TeacherId = 1 });
//                    context.CourseManagements.Add(new CourseManagement() { StudentId = 2, TeacherId = 2 });
//                    context.CourseManagements.Add(new CourseManagement() { StudentId = 3, TeacherId = 3 });
//                    context.CourseManagements.Add(new CourseManagement() { StudentId = 4, TeacherId = 4 });
//                    context.CourseManagements.Add(new CourseManagement() { StudentId = 5, TeacherId = 5 });
//                    context.CourseManagements.Add(new CourseManagement() { StudentId = 6, TeacherId = 6 });
//                    context.CourseManagements.Add(new CourseManagement() { StudentId = 7, TeacherId = 7 });
